...
import ModelListPage from "../../components/ModelListPage/ModelListPage";
import {
...
interface ModelListProps {
  params: ModelListUrlQueryParams;
}

export const ModelList: React.FC<ModelListProps> = ({ params }) => {
  ...
  const handleSort = createSortHandler(navigate, modelListUrl, params);
          ...
          {(collectionBulkPublish, collectionBulkPublishOpts) => (
            <>
              <ModelListPage
                ...
                onRowClick={id => () => navigate(modelUrl(id))}
                toolbar={
                  <>
                    <Button
                      color="primary"
